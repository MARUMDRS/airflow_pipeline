...
class Repository:
    def __init__(self, repo_data):
        ...
        self.full_name = repo_data.full_name  # _id
    ...
    # Setters
    def set_has_pandas(self, value: bool):
        self.has_pandas = value

    def set_is_downloaded(self, value: bool):
        self.is_downloaded = value

    def set_is_extracted(self, value: bool):
        self.is_extracted = value

    def set_is_preprocessed(self, value: bool):
        self.is_preprocessed = value

    def set_is_ready_for_training(self, value: bool):
        self.is_ready_for_training = value

    def set_needs_manual_review(self, value: bool):
        self.needs_manual_review = value
